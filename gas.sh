...
sleep 15
echo "Continuing install, this will prompt you for your password if you're not already running as root and you didn't enable passwordless .  Please do not run me as root!"
if [[ `whoami` == "root" ]]; then
